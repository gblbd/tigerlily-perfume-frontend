...
const Header = () => {
  return (
    <section className="relative">
      <div className="max-w-screen-2xl mx-auto h-[80vh] lg:h-[1047px] bg-gradient-backdrop py-10">
        ...
        <div className="flex justify-center items-center gap-3 pt-5 md:pt-10">
        ...
        <div className="absolute top-1/3 md:top-[40%] left-5 md:left-[20%] border-l-2">
        ...
        <div className="absolute top-1/4 md:top-2/3 right-5 md:left-[20%] text-white pt-10">
        ...
        <div className="flex items-center gap-2 absolute bottom-5 left- md:left-1/4 top-1/2 px-5 md:px-10">
          <img
            src={leftimage}
            alt="leftimage"
        ...
        <div className="absolute left-0 right-0 top-1/2 flex justify-center items-center py-5">
          <img
            src={middleimage}
            alt="middleimage"
            className="w-1/3 md:w-[280px] lg:w-[358px] lg:h-[493px]"
          />
        </div>
      </div>
    </section>
